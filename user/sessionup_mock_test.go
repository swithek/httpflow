...
// Ensure, that StoreMock does implement sessionup.Store.
// If this is not the case, regenerate this file with moq.
var _ sessionup.Store = &StoreMock{}

// StoreMock is a mock implementation of sessionup.Store.
//
...
func (mock *StoreMock) Create(ctx context.Context, s sessionup.Session) error {
...
func (mock *StoreMock) FetchByID(ctx context.Context, id string) (sessionup.Session, bool, error) {
...
func (mock *StoreMock) FetchByUserKey(ctx context.Context, key string) ([]sessionup.Session, error) {
